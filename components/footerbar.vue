<template>
  <footer class="bg-gradient-to-r from-indigo-500 to-indigo-600 text-gray-300 px-6 py-5 lg:px-8 ">
    <!-- <div class="max-w-screen-xl mx-auto mb-12 lg:mb-16  ">
      hell
    </div> -->

    <!-- <div class="max-w-screen-xl mx-auto flex flex-col md:flex-row justify-between items-center space-y-4  lg:mt-20 border-t-2 border-gray-700 pt-8 ">
